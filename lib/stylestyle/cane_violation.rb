require 'stylestyle/cane_violation/abc_max_violation'
require 'stylestyle/cane_violation/undocumented_class_violation'
require 'stylestyle/cane_violation/style_violation'
require 'stylestyle/cane_violation/syntax_violation'
require 'stylestyle/cane_violation/threshold_violation'
